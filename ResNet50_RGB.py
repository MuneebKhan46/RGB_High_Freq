...
resnet50_wcw_model.compile(optimizer='adam', loss='binary_crossentropy', metrics=['accuracy'])
    
wcw_model_checkpoint = keras.callbacks.ModelCheckpoint(filepath='/WACV_Paper/Models/ResNet50_RGB_wCW.keras', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1)
...
file_path = '/WACV_Paper/Plots_CSV/ResNet50_RGB_wCW_PR_Curve.csv'
...
plt.legend()
plt.grid(True)
precision_recall_curve_path = '/WACV_Paper/Plots_RGB/ResNet50_RGB_wCW_PR_Curve.png'
...
pr_data = pd.DataFrame({'Precision': precision, 'Recall': recall })
file_path = '/WACV_Paper/Plots_CSV/ResNet50_RGB_CW_PR_Curve.csv'
pr_data.to_csv(file_path, index=False)
...
plt.legend()
plt.grid(True)
precision_recall_curve_path = '/WACV_Paper/Plots_RGB/ResNet50_RGB_CW_PR_Curve.png'
