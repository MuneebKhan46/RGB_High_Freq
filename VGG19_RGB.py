...
vgg19_wcw_model.compile(optimizer=Adam(learning_rate=0.001), loss='binary_crossentropy', metrics=['accuracy'])

wcw_model_checkpoint = keras.callbacks.ModelCheckpoint(filepath='/WACV_Paper/Models/VGG19_RGB_wCW.keras', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1)
...
vgg19_cw_model.compile(optimizer=Adam(learning_rate=0.001), loss='binary_crossentropy', metrics=['accuracy'])

cw_model_checkpoint = keras.callbacks.ModelCheckpoint(filepath='/WACV_Paper/Models/VGG19_RGB_CW.keras', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1)
